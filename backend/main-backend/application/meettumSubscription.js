...
const subScriptionPlan = [
  { name: "month", price: 1500, planId: "1" },
  { name: "6 month", price: 7500, planId: "2" },
  { name: "Year", price: 14000, planId: "3" },
];
...
class MeettumSubscription {
  ...
  getNextPaymentDate = (planId, prevPaymentDate) => {
    ...
    switch (planId) {
      ...
      case "2":
        ...
        break;
      case "3":
        nextPaymentDate = moment(prevPaymentDate)
          .add(365, "days")
          .format("YYYY-MM-DD");
        break;
    }
  ...
  chargeUserForMeettumSubScription = async (userSubscription) => {
    ...
    if (paymentIntent.status == PAYMENT_SUCCEEDED) {
      ...
      userSubscription.nextPaymentDate = this.getNextPaymentDate(
