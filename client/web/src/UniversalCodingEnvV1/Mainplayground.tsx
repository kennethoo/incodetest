...
import CodeSanBoxV2 from "UniversalCodingEnvV1/CodeSanBoxV2";
import Header from "UniversalCodingEnvV1/Header";
...
const Mainplayground = ({
      ...
      return {
        desktop: [
          ...
          },
          {
            ...
            label: "AI Explain",
            tabComponent: <Explain codeLog={result} />,
            doNotShow: !codeWorkSession.isAIEnabled,
          },
        ],
      };
    }
  ...
  return (
    <Container>
      <Header codeWorkSession={codeWorkSessionData} />
