  ...
  return (
    <div className="wrapririr">
      ...
      <p>
        ...
        reliability, and appropriateness. you must keep in mind that only post
        realted to fitness or sport are allow.
      </p>
      <p>
        Any post that is not related to fitness or sport will be taken down with
        a warning, if you keep posting or uploading content that is not related
        to our platform kind your account will be <b>Banned</b>
      </p>
      <p>
      ...
      <p>
        ...
        of Content or the failure to succeededsfully restore Content to a usable
        state.
      </p>
      <p>
      ...
      <p>
        ...
        copyright agent via email at meettum_inc@outlook and include in Your
      ...
      <p>
        You can contact our copyright agent via email at meettum_inc@outlook.
      ...
      <ul>
        <li>By email: meettum_inc@outlook</li>
      </ul>
    </div>
  );
}
